...
# plt.title('IcebergID: %s'%((int(tracker_id))))
plt.title('NO GrIS - Iceberg tracking velocity: Jan-July 2019')
plt.xticks()
# plt.xlim(1,220)
# plt.ylim(0,100)
...
plt.tight_layout()
plt.savefig(os.path.join(path_,'NO_velocity_icebergs_scatterplot_all_instances_Jan-July_2019.png'),dpi=300)
plt.show()
